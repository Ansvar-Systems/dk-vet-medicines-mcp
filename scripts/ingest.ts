 ...
 * See the UK implementation (uk-vet-medicines-mcp) for the reference pattern.
 *
...
console.log('See uk-vet-medicines-mcp/scripts/ingest.ts for the reference pattern.');
