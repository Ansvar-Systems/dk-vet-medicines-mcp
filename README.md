# Denmark Vet Medicines MCP

[![CI](https://github.com/Ansvar-Systems/dk-vet-medicines-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/dk-vet-medicines-mcp/actions/workflows/ci.yml)
[![GHCR](https://github.com/Ansvar-Systems/dk-vet-medicines-mcp/actions/workflows/ghcr-build.yml/badge.svg)](https://github.com/Ansvar-Systems/dk-vet-medicines-mcp/actions/workflows/ghcr-build.yml)
...
```json
{
  "mcpServers": {
    "uk-vet-medicines": {
      "command": "npx",
      "args": ["-y", "@ansvar/dk-vet-medicines-mcp"]
    }
  }
}
```
...
```bash
claude mcp add uk-vet-medicines npx @ansvar/dk-vet-medicines-mcp
```

### Streamable HTTP (remote)

```
https://mcp.ansvar.eu/dk-vet-medicines/mcp
```

### Docker (self-hosted)

```bash
docker run -p 3000:3000 ghcr.io/ansvar-systems/dk-vet-medicines-mcp:latest
```

### npm (stdio)

```bash
npx @ansvar/dk-vet-medicines-mcp
```
